...
3. Search for "Biji Tongbu"
4. Click Install

### Manual Installation

1. Download the latest `main.js`, `manifest.json`, and `styles.css` from [Releases](https://github.com/notesynchelper/obsidian-bijitongbu/releases)
2. Copy these files to your vault's `.obsidian/plugins/bijitongbu/` directory
3. Reload Obsidian
4. Enable "Biji Tongbu" in Settings
...
- Submit a [GitHub Issue](https://github.com/notesynchelper/obsidian-bijitongbu/issues)
...
1. 从 [Releases](https://github.com/notesynchelper/obsidian-bijitongbu/releases) 下载最新版本的 `main.js`、`manifest.json` 和 `styles.css`
2. 将这些文件复制到你的 vault 的 `.obsidian/plugins/bijitongbu/` 目录下
3. 重新加载 Obsidian
4. 在设置中启用"Biji Tongbu"插件
...
- 提交 [GitHub Issue](https://github.com/notesynchelper/obsidian-bijitongbu/issues)
